<template>
    <div class="brook-icon-boxes-area pb--120 pb_md--80 pb_sm--80 poss_relative">
        ...
        data () {
            return {
                services: [
                    {
                        id: 1,
                        icon: "/img/service/icon-box/modern_design.png",
                        alt: "icon image",
                    ...
                    {
                        id: 2,
                        icon: "/img/service/icon-box/ui_ux_design.gif",
                        alt: "icon image",
                    ...
                    {
                        id: 3,
                        icon: "/img/service/icon-box/seo_marketing.gif",
                        alt: "icon image",
